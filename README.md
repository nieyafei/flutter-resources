...
* [Flutter中文网2](https://flutterchina.club/)
* [Flutter开源库](https://github.com/flutter/flutter)
* [Flutter实战](https://book.flutterchina.club/)
* [awesome-flutter: 一个flutter的项目、文档、教程的资源整合和收藏](https://github.com/Solido/awesome-flutter)
* [阿里：flutter-go：flutter 开发者帮助 APP](https://github.com/alibaba/flutter-go)
...
* [Flutter插件](https://github.com/flutter/plugins)
* [Flutter的日期选择器控件](https://github.com/wuzhendev/flutter-cupertino-date-picker)
...
* [Flutter的电商实战项目](https://github.com/shenghy/flutter_shop)
* [InKino: 完整的电影应用程序](https://github.com/roughike/inKino)
* [Beer-Me-Up](https://github.com/benoitletondor/Beer-Me-Up)
* [Music Player: Pawan Kumar 开发的全功能音乐播放器](https://github.com/iampawan/Flutter-Music-Player)
* [WhatTodo](https://github.com/burhanrashid52/WhatTodo)
* [DroidKaigi2018-flutter: 东京 DroidKaigi 2018 的非官方会议应用](https://github.com/konifar/droidkaigi2018-flutter)
* [开发知乎App的Flutter版](https://github.com/MeandNi/Flutter_ZhiHu)
* [仿luckin coffee的FlutterApp](https://github.com/wuxiaowei888765/flutter_coffee)
* [天气查询App](https://github.com/koudle/GDG_Flutter_Weather_Demo)
...
* [flutter开发俄罗斯方块](flutter开发俄罗斯方块)

## Flutter库资源

* [Flutter：loading动画库](https://github.com/TinoGuo/loading_indicator)
* [flutter_easyloading - 一个简单易用的Flutter Loading插件，包含23种动画效果，总有你满意的](https://github.com/huangjianke/flutter_easyloading)

## 其它

* [flutter应用收集 MADE BY THE FLUTTER社区](https://itsallwidgets.com/)
* [日更的FlutterDemo合集](https://github.com/OpenFlutter/Flutter-Notebook)
* [Flutter-learning: 个人开源项目，2600Star](https://github.com/AweiLoveAndroid/Flutter-learning)
